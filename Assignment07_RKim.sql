...
Begin Try
	Use Master;
	If Exists(Select Name From SysDatabases Where Name = 'Assignment07DB_RKim')
	 Begin 
	  Alter Database [Assignment07DB_RKim] set Single_user With Rollback Immediate;
	  Drop Database Assignment07DB_RKim;
	 End
	Create Database Assignment07DB_RKim;
End Try
Begin Catch
	Print Error_Number();
End Catch
...
-- <Put Your Code Here> --
create 
view vProductInventoriesWithPreviousMonthCountWithKPIs
as 
	Select top 1000000
	ProductName,
	InventoryDate,
...
-- Check that it works: Select * From vProductInventoriesWithPreviousMonthCountWithKPIs;
go
